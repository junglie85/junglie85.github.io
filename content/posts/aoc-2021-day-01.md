...
[Source code](https://github.com/junglie85/aoc-2021/commit/b1cf3386101a8aeeac3733a7296b155fbdf38e69) for this solution can be found in the associated GitHub repository.
...
Let's use this sample data to create a program that will solve the challenge!
Let's handle the cases where there are only zero or 1 measurements; we'll return a `None` value.
...
So, great success, let's award ourselves with another ⭐️.
